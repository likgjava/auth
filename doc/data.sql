...
-- ----------------------------
INSERT INTO `auth_role` VALUES ('1', 'admin', '超级管理员', '', null, null);
...
CREATE TABLE `auth_user` (
  ...
  `status` char(2) default NULL COMMENT '使用状态',
  `create_time` datetime default NULL COMMENT '创建时间',
  PRIMARY KEY  (`id`),
...
-- ----------------------------
INSERT INTO `auth_user` VALUES ('1', 'test02', '1', '11111', 'fdsaf@11.com', null, null, null, null, null, '2012-11-01 14:01:09');
